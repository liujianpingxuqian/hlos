...
align 4096			; align to 2^12(4096) page_size
pgd_tmp_d: times 1024 dd 0	;

pte_low_d: times 1024 dd 0	;  map VA 0~4M range to PA 0~4M

pte_high_d: times 1024*4 dd 0	;  map VA 3G~(3G+16M) range to PA 0~16M

stack:    times 1024 db 0       ; 这里作为临时内核栈
STACK_TOP equ $-stack-1         ; 内核栈顶，$ 符指代是当前地址

pte_low: dd pte_low_d
pgd_tmp: dd pgd_tmp_d
pte_high: dd pte_high_d
